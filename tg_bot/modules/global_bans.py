...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text("⚡️Boom!Another one got hit by DragonClaws⚡️")
...
def ungban(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text("Person has been paradon sucessfuly and free from gban.")
...
def gbanlist(bot: Bot, update: Update):
    ...
    if not banned_users:
        update.effective_message.reply_text("There haven't any gbanned users! You're kinder than I expected...")
        return
...
def check_and_ban(update, user_id, should_message=True):
    if sql.is_user_gbanned(user_id):
        ...
        if should_message:
            update.effective_message.reply_text("This is a unacceptable person marked by @DragonAssociationSupport, he/she shouldn't be here!")
...
__help__ = """
*Admin only:*
 - /gbanstat <on/off/yes/no>: Will disable the effect of general bans on your group, or return your current settings.
Gbans, also known as general bans, are used by the bot owners to ban spammers across all groups. This helps protect \
you and your groups by removing spam flooders as quickly as possible. They can be disabled for you group by calling \
/gbanstat
"""

__mod_name__ = "General Bans"
